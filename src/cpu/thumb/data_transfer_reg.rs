...
{   
    ...
    match lbh
    {
        ...
        0b001 => memory.store16(address, cpu.r[rd as usize] as u16),
        0b010 => memory.store8(address, cpu.r[rd as usize] as u8),
        0b011 => cpu.r[rd as usize] = memory.load8(address) as i8 as i32 as u32,
