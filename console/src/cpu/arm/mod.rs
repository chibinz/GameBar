...
pub fn dispatch(cpu: &mut CPU, memory: &mut Memory) {
    ...
    let data_process_psr_bx = |cpu: &mut CPU| {
        match instruction.bits(24, 20) {
            ...
            0b10010 => {
                if b74() == 0 {
                    psr_transfer::interpret(cpu, instruction)
                } else {
    ...
    let multiply_swap = |cpu: &mut CPU, memory: &mut Memory| {
        match instruction.bits(24, 20) {
            0b00000 | 0b00001 | 0b00010 | 0b00011 => {
                multiply_accumulate::interpret(cpu, instruction)
            }
            0b01000 | 0b01001 | 0b01010 | 0b01011 | 0b01100 | 0b01101 | 0b01110 | 0b01111 => {
                multiply_long_accumulate::interpret(cpu, instruction)
            }
    ...
    match instruction.bits(27, 25) {
        ...
        0b010 | 0b011 => single_data_transfer::interpret(cpu, memory, instruction),
